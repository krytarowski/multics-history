...
unlink **.info -brief
do "link [dir &ec_dir]>login_info>&&1.info &&1.info;
&+  copy_names [dir &ec_dir]>login_info>&&1.info &&1.info"
&+ (hangup access_class echo hello modes noecho terminal_id terminal_type)
